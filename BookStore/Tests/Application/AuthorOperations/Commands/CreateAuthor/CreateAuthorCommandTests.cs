...
namespace BookStore.UnitTest.Application.AuthorOperations.Commands.CreateAuthor
{
    public class CreateAuthorCommandTests : IClassFixture<CommonTestFixture>
    {
        ...
        public void WhenAlreadyExistAuthorNameIsGiven_InvalidOperationException_ShouldReturn()
        {
            ...
            FluentActions.Invoking(() => command.Handle()).Should().Throw<InvalidOperationException>().And.Message.Should().Be("An author with the same name and surname already exists.");

        }
    }
}//Aynı isim ve soyisime sahip yazar bulunmaktadır